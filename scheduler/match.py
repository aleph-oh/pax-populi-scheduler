...
class Match:
    ...
    def get_course_schedules(self):
        ...
        student_course_schedule = list(map(self.student.tz.localize,
    ...
    def to_dict(self):
        ...
        student_schedule_strings = list(map(dt_to_str, self.student_course_schedule))
        tutor_schedule_strings = list(map(dt_to_str, self.tutor_course_schedule))
        UTC_schedule_strings = list(map(dt_to_str, self.UTC_course_schedule))
